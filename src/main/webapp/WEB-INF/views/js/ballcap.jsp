	...
	<section class="ccontainer">
		<div class="cwrapper">
			<div class="newsslider">
			    <div class="newsslide"><i>회원 가입시 적립금 1000000만 증정!!!!!</i></div>
			...
			<form action="pro_sort.do" method="get" class="sortform" id="sortForm">
			    <select name="sort" class="sort" id="sortSelect">
			        <option value="latest" ${param.sort eq 'latest' ? 'selected' : ''}>신상품순</option>
			...
			<c:forEach var="k" items="${list}">
				<div class="citem">
						...
						<a href="pro_detail.do?pro_idx=${k.pro_idx}"><img src="${path}/resources/img/ballcap/${k.pro_img1}" class="cimg">
						<div class="ctext">
