...
<script type="text/javascript">
	function address_update_ok(f) {
		f.action="address_update_ok.do";
		f.submit();
	}
...
<body>
	<div class="pcontainer">
		<div class="pwrapper">
			<h3 class="sub2">배송지 수정</h3>
			<form method="post" class="pform">
				<ul class="pform2">
					<li>
						<label for="uname2">수령자</label> 
						<input type="text" class="ip1" id="uname2" name="send_name" value="${avo.send_name }" required>
					</li>
					<li>
						<label for="upostcode2">우편번호</label> 
						<input type="text" id="sample6_postcode2" class="ip2" value="${avo.send_postcode }" name="send_postcode">
						<input type="button" class="ip2" id="sb1" onclick="sample6_execDaumPostcode2()" value="검색하기"><br>
					</li>
					<li>
						<label for="uaddr2">주소</label> 
						<input type="text" id="sample6_address2" class="ip1" value="${avo.send_addr }" name="send_addr"><br>
						<input type="text" id="sample6_detailAddress2" class="ip1" value="${avo.send_addrdetail }" name="send_addrdetail">
					</li>
					<li class="ip3">
					...
					<li>
						...
						<input type="text" class="ip1 ts1" id="uemail3" name="send_msg" value="${avo.send_msg }" style="text-align: left;" required>
					</li>
				<p class="ppay3">
					<input type="submit" class="ppay1" value="수정하기" onclick="address_update_ok(this.form)"> 
