...
<script type="text/javascript">
	function TermOfUse(f) {
		location.href="create_acc_go.do";
	}
</script>
</head>
<body>
      ...
      <div class="contents">
        <form action="/" method="POST" id="form__wrap">
          <div class="terms__check__all">
            ...
            <label for="checkAll"
              >ICT 쇼핑몰 이용약관, 개인정보 수집 및 이용, 정보 수신(선택)에<br/>모두 동의합니다.</label>
          </div>
          <ul class="terms__list">
            <li class="terms__box">
              <div class="input__check">
                <input type="checkbox" name="agreement" id="termsOfService" value="termsOfService" required/>
                <label for="termsOfService" class="required">ICT 이용약관 동의</label>
              </div>
              <div class="terms__content">
                여러분을 환영합니다. ICT 쇼핑몰 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 ICT 쇼핑몰
                서비스의 이용과 관련하여 ICT 쇼핑몰 서비스를 제공하는 ICT 쇼핑몰 주식회사(이하 ‘ICT’)와 이를 이용하는 ICT 서비스
                회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 ICT 서비스 이용에 도움이 될 수 있는
                유익한 정보를 포함하고 있습니다. ICT 서비스를 이용하시거나 ICT 서비스 회원으로 가입하실 경우 여러분은 본
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                개인정보보호법에 따라 ICT에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                ICT에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(ICT앱 알림 또는 문자), 이메일로 받아보실 수
                있습니다. 일부 서비스(별도 회원 체계로 운영하거나 ICT 가입 이후 추가 가입하여 이용하는 서비스 등)의
                경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고
                동의를 받습니다.
              </div>
            </li>
          </ul>
          <button type="submit" class="next-button" onclick="TermOfUse(this.form)" disabled>확인</button>
        </form>
      </div>
    </div>
</body>
