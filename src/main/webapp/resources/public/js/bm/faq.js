...
const qwrapper = document.querySelectorAll('.qwrapper');
...
const handlingClicked = function(e){
    ...
    if(!checked) return;
        ...
        qwrapper.forEach(w=>w.classList.remove('onshowing'));

        checked.classList.add('checked');
        document.querySelector(`.qwrapper--${checked.dataset.box}`).classList.add("onshowing");
}
